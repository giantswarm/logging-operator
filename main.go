...
func main() {
	...
	flag.Var(&includeEventsFromNamespaces, "include-events-in-namespaces", "List of namespaces to collect events from on workload clusters (if empty, collect from all namespaces)")
